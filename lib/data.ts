...
export const OWNER = {
  ...
  role: "AI Engineer",
  tagline:
    "Building intelligent AI-powered solutions using Machine Learning, Computer Vision and modern web technologies.",
  bio: "B.Tech Electronics and Communication Engineering student passionate about AI, Machine Learning, Computer Vision and intelligent software systems.",
...
export const TIMELINE: TimelineItem[] = [
  ...
  },
  {
    year: "2025",
    title: "Internship",
    description: "Applied electronics and AI concepts in an industry setting.",
    type: "internship",
  },
  {
    year: "2026",
    title: "Certifications & Achievements",
    description: "Completed certifications in ML and computer vision; expanded project portfolio.",
    type: "achievement",
  },
  {
    year: "Now",
